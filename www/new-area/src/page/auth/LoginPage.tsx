...
import { Loader2, Github, Mail, Lock } from "lucide-react";
...
export default function LoginPage({ className, ...props }: UserAuthFormProps) {
  ...
  return (
    <div className={`flex justify-center items-center h-screen bg-gradient-to-br from-blue-900 to-purple-900 ${className}`} {...props}>
